...
class Gr1ArmsOnlyDataConfig(BaseDataConfig):
    ...
    language_keys = ["annotation.human.annotation.task"]
...
class Gr1FullUpperBodyDataConfig(BaseDataConfig):
    ...
    language_keys = ["human.annotation.task"]
    observation_indices = [0, 16]
    action_indices = list(range(16))
...
#     state_keys = ["state.left_arm", "state.right_arm", "state.left_hand", "state.right_hand", "state.base"]
#     action_keys = ["action.left_arm", "action.right_arm", "action.left_hand", "action.right_hand", "action.base"]
#     language_keys = ["annotation.human.action.task_description"] 
#     observation_indices = [0, 26]
...
class M1DataConfig(BaseDataConfig):
    video_keys = ["video.cam_head"]
    state_keys = [
        "state.left_arm",
        "state.right_arm",
